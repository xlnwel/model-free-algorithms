...
class Agent(OffPolicyOperation):
    ...
    def __init__(self, 
        ...
        if self.schedule_lr:
            self.actor_lr_scheduler = PiecewiseSchedule([(0, 1e-4), (400000, 1e-4), (600000, 1e-5)], outside_value=1e-5)
            self.Q_lr_scheduler = PiecewiseSchedule([(0, 3e-4), (400000, 3e-4), (600000, 1e-5)], outside_value=1e-5)
            self.alpha_lr_scheduler = PiecewiseSchedule([(0, 1e-4), (400000, 1e-4), (600000, 1e-5)], outside_value=1e-5)
